...
4. **I want to know what is the ideal.** That way I can decide how to adjust it.
...
5. **I want to use my choice of chemicals.**
...
6. **I want to know Saturation Index.** This tells me whether the overall water balance is corrosive to my pipes, or will deposit scale, or if it's just right.
7. **I don't want to create a login and password.** I don't want my email sold to mailing lists. I don't want advertising.
   * This web-app only saves data locally, in the browser cache on your device.
8. **I have no need to keep history.** Who cares what were my chemical levels 5 months ago? They were all within the ideal range, of course. Why do I need an app to tell me that I haven't measured the water for a week, or that I need to shock? I can figure those things out better myself. The only history I care about is the previous reading, to make it easier to count drops.
...
* I'd be delighted to accept contributions! This software is all open-source. You can use it, copy it, adapt it as you see fit.
